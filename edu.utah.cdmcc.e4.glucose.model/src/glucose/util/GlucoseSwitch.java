 ...
 * @generated
 */
public class GlucoseSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GlucosePackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GlucosePackage.PATIENT: {
			...
			case GlucosePackage.CLINICAL_DECISION: {
				ClinicalDecision clinicalDecision = (ClinicalDecision)theEObject;
				T result = caseClinicalDecision(clinicalDecision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GlucosePackage.GLUCOSE_DECISION: {
				GlucoseDecision glucoseDecision = (GlucoseDecision)theEObject;
				T result = caseGlucoseDecision(glucoseDecision);
				if (result == null) result = caseClinicalDecision(glucoseDecision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GlucosePackage.INTENSIVE_CARE_UNIT: {
	 ...
	 * @generated
	 */
	public T caseGlucoseDecision(GlucoseDecision object) {
		return null;
	}
