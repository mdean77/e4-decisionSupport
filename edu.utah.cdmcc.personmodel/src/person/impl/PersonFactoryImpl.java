...
public class PersonFactoryImpl extends EFactoryImpl implements PersonFactory {
	...
	public static PersonFactory init() {
		try {
			PersonFactory thePersonFactory = (PersonFactory)EPackage.Registry.INSTANCE.getEFactory("http://edu/utah/cdmcc"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PersonPackage.PATIENT: return createPatient();
			case PersonPackage.USER: return createUser();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PersonPackage.ACCESS_TYPE:
				return createAccessTypeFromString(eDataType, initialValue);
			case PersonPackage.STATUS_TYPE:
